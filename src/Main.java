...
// Using getters and showing some other features of the class
        ...
        System.out.println("The amount of eggs required for the " + client3.getPartyName() + " party is " + client3.calcEggs());
                ...
                System.out.println("The total cost of " + client3.getPartyName() + " breakfast is " +

                        client3.calcCost() + " excluding tax and tip");
        ...
        System.out.println();
        System.out.println("The total cost of " + client4.getPartyName() + " breakfast is " +

                client4.calcCost() + " excluding tax and tip");
